...
from backend.db.session import SessionLocal, create_database_tables  # noqa: E402
from backend.modules.translator.services.translation_memory_service import TranslationMemoryService  # noqa: E402
